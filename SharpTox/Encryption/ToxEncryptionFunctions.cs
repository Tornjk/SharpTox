...
namespace SharpTox.Encryption
{
    ...
    {
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_derive_key_from_pass")]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_derive_key_with_salt")]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_get_salt")]
        [return: MarshalAs(UnmanagedType.I1)]
        internal static extern bool GetSalt(byte[] data, byte[] salt);

        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_pass_key_encrypt")]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_pass_encrypt")]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_pass_key_decrypt")]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_pass_decrypt")]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport(Extern.DLL, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tox_is_data_encrypted")]
        [return: MarshalAs(UnmanagedType.I1)]
